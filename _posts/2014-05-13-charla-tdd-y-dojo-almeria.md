...
¡Las katas son ejercicio de programación organizados por personas para personas! Si tienes alguna duda sobre las katas, o TDd o tu entorno de desarrollo o si puede ser ser una buena idea asistir o no escribe al facilitador a esta dirección de correo: javierj@us.es y coméntaselo, que su misión es ayudar en todo lo que le pidan.
...
Los asistentes pueden usar el lenguaje y herramienta que quieran. el facilitador proporcionaráá ejemplos en Java / Eclipse y en Python / Pycharm.


### Breve currículum de Javier Gutiérrez

[Javier Gutiérrez](https://twitter.com/iwt2_javier﻿) es profesor en la ETSII en la Universidad de Sevilla y TDD infected e infector. colabora con varios blogs como AprendiendoTDD, Pybonacci, IndieORama, etc. con artículos sobre pruebas, participa en congresos como la Conferencia Agile Spain, codemotion, etc. también con artículos de prueba y cuando tiene oportunidad de colarse en alguna empresa dónde aún no le conoce enseguida organiza un atarde de pruebas TDD, café y pasteles.

Además de las prueba,s también es un gran aficionado a ayudar  los demás en sus proyectos. Ha colaborado y colabora en distintos proyectos de software libre y anima todo el que quiera hacer videojuegos a que se ponga a ello con el club GameUS y distintas visitas a las Betabeers de Andalucía.
